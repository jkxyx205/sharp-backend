...
public class DBInit {
    ...
    private static String folder = "/Users/rick/Space/Share"; // timeline-2025-12-09.sql
    ...
    public void init() throws IOException, SQLException {
        ...
        File folder = new File(DBInit.folder);
        ...
        DbScriptUtils.importSQL(connection, sqlContent.replaceAll(FILE_DATABASE_NAME, database));
        connection.close();
    ...
    private DataSource dataSource() {
        ...
        dataSource.setUrl(databaseProperties.getProperty("JDBC.URL").replaceAll("(jdbc:mysql://[^/]+)/.*", "$1"));
